...
*/
export function run_terrain_generator(canvas, imgwidth, imgheight) {
    wasm.run_terrain_generator(addHeapObject(canvas), imgwidth, imgheight);
}
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('terrain_rs_minivisualizer_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
